...
def check_missing_effects():
    '''
    Validate .cwt files with effects against documentation file (script_documentation.json)\n
    ...
    Effects can be added to ignore by including them into FALSE_POSITIVES list
    '''
